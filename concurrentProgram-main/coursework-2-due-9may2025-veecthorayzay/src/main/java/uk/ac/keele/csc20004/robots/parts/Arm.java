 ...
 */
public class Arm extends AbstractRobotPart implements Actuator {
    private static final double ARM_BASE_ENERGY_COEFF = 0.10;
    private static final double ARM_ATTACK_COEFF = 0.30;

    /**
     * Constructor for an Arm, which calls the superclass constructor
     * with the base energy coefficient for this part.
     */
    public Arm() {
        super(ARM_BASE_ENERGY_COEFF);
    }
